...
When using a map file, provide the file name as a command line argument with the executable. Ex: if the file is called map.txt, place the file in the same directory and run [path to executable] map.txt
